...
describe('<Modal/>', () => {
  ...
  it('renders <ReactModal>', () => {
    const wrapper = shallow(<Modal show handleClick={mockFn} />)
    expect(wrapper.length).toEqual(1)
  })
  // Make sure that its rendered correctly
  it('should render correctly', () => {
    const wrapper = shallow(<Modal show>This works</Modal>)
    expect(wrapper).toMatchSnapshot()
  })
  // Make sure that it renders the children correctly
  it('renders children correctly', () => {
    const wrapper = shallow(<Modal show handleClick={mockFn}>It works</Modal>)
