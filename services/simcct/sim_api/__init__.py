...
def create_app(configs_path=app_settings) -> Flask:
    ...
    with app.app_context():
        ...
        app.register_blueprint(users_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(auth_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(user_alloys_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(admin_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(share_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(last_sim_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(save_sim_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(ratings_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(configs_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(alloys_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(sim_blueprint, url_prefix='/v1/sim')
        app.register_blueprint(sim_alloys_blueprint, url_prefix='/v1/sim')
