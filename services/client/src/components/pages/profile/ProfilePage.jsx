  ...
  constructor(props) {
    ...
    */
    this.state = {
      ...
      question1: props.user.profile
        ? {label: props.user.profile.aim, value: props.user.profile.aim}
        : null,
      question1Select: [
      ...
      question2: props.user.profile 
        ? {label: props.user.profile.highest_education, value: props.user.profile.highest_education}
        : null,
      question2Select: [
        { label: 'Q2 Option 1', value: 'Q2 Option 1' },
        { label: 'Q2 Option 2', value: 'Q2 Option 2' },
      ],
      question3: props.user.profile 
        ? {label: props.user.profile.sci_tech_exp, value: props.user.profile.sci_tech_exp}
        : null,
      question3Select: [
        { label: 'Q3 Option 1', value: 'Q3 Option 1' },
        { label: 'Q3 Option 2', value: 'Q3 Option 2' },
      ],
      question4: props.user.profile 
        ? {label: props.user.profile.phase_transform_exp, value: props.user.profile.phase_transform_exp}
        : null,
      question4Select: [
