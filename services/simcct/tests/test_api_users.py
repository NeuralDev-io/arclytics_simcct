...
class TestUserService(BaseTestCase):
    ...
    def test_single_user(self):
        ...
        with self.client as client:
            ...
            cookie = test_login(client, tony.email, 'IAmTheRealIronMan')
    ...
    def test_user_status(self):
        ...
        with self.client:
            test_login(self.client, tony.email, 'iamironman')
            ...
            self.assertFalse(data['isProfile'])
    ...
    def test_get_all_users_no_cookies(self):
        with self.client:
            resp = self.client.get(
                '/api/v1/sim/users', content_type='application/json'
            )
            data = json.loads(resp.data.decode())
