...
from mongoengine import connect, get_db, get_connection
from mongomock import MongoClient

import settings
from sim_api.app import get_flask_mongo
from sim_api.extensions import MongoAlloys
from sim_api.models import User, Configuration, AlloyStore
...
class TestAlloyService(BaseTestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.shuri.set_password(cls._pw)
        ...
        user = cls.mongo.users.find_one({'email': 'shuri@wakanda.com'})
