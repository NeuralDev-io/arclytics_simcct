    ...
    <div className={styles.container}>
      ...
      <section>
        ...
        <div className={styles.content}>
          <p>
            Arclytics team is committed to providing quality services to you and this policy outlines our ongoing
      ...
      <section>
        ...
        <div className={styles.content}>
          <p>
            ...
            Information we collect include: names , email adresses and educational experience.
          </p>
          <p>
            This Personal Information is obtained in many ways including via our website’s (app.arclytics.io)
            registration form and user profile. We don’t guarantee website links or policy of authorised third parties.
          </p>
          <p>
          ...
          <p>
            When we collect Personal Information we will, where appropriate and where possible, explain to you why we
      ...
      <section>
        ...
        <div className={styles.content}>
          ...
          <ul>
            <li>To use for user analytics for discovering the demographic of the application.</li>
      ...
      <section>
        ...
        <div className={styles.content}>
          ...
          <p>
            The NeuralDev team will not charge any fee for your access request, but may charge an administrative fee for
            providing a copy of your Personal Information. Additionally, your Personal Information can also viewed in
            the user profile page of the web application.
          </p>
          <p>
      ...
      <section>
        ...
        <div className={styles.content}>
          <p>
            It is important to us that your Personal Information is up to date. We will take reasonable steps to make
      ...
      <section>
        ...
        <div className={styles.content}>
          <p>
            ...
            <a href="https://app.arclytics.io/about/privacy">app.arclytics.io/about/privacy</a>.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className={styles.content}>
          ...
          <p>NeuralDev</p>
          <p><a href="mailto: admin@neuraldev.io">admin@neuraldev.io</a></p>
        </div>
      </section>
