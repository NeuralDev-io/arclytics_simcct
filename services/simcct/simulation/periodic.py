...
class PeriodicTable(enum.Enum):
    ...
    B = Element(5, 'Boron', 'B', 10.83)
    C = Element(6, 'Carbon', 'C', 12.011)
    N = Element(7, 'Nitrogen', 'N', 14.007)
    Mg = Element(12, 'Magnesium', 'Mg', 24.305)
    Al = Element(13, 'Aluminium', 'Al', 26.982)
    Si = Element(14, 'Silicon', 'Si', 28.085)
    P = Element(15, 'Phosphorous', 'P', 30.974)
    S = Element(16, 'Sulphur', 'S', 32.06)
    ...
    V = Element(23, 'Vanadium', 'V', 50.942)
    Cr = Element(24, 'Chromium', 'Cr', 51.996)
    Mn = Element(25, 'Manganese', 'Mn', 54.938)
    Fe = Element(26, 'Iron', 'Fe', 55.845)
    Co = Element(27, 'Cobalt', 'Co', 58.933)
    ...
    Nb = Element(41, 'Niobium', 'Nb', 92.906)
    Mo = Element(42, 'Molybdenum', 'Mo', 95.95)
    ...
    W = Element(74, 'Tungsten', 'W', 183.84)
